...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/orgulho-neve-7d88)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/orgulho-neve-7d88
```

A live public deployment of this template is available at [https://orgulho-neve-7d88.templates.workers.dev](https://orgulho-neve-7d88.templates.workers.dev)
